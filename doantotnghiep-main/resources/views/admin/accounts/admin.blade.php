    ...
    <div class="main-container">
        ...
        <div class="main-content">
            <div class="wrap-content">
                                    ...
                                    <td>
                                        @if ($v['avatar'] != null)
                                            <div class='pic m-auto' style="max-width: 50%"><img
                                                    ...
                                                    src='../public/uploads/users/admins/{{ $v['id'] }}/{{ $v['avatar'] }}'
                                                    alt=''></div>
                                        @else
                                            <div class="pic m-auto" style="max-width: 50%"><img
                                                    style="width:100%;aspect-ratio: 1/1;object-fit: cover;"
                                        ...
                                        <td>
                                            <div class="v-center change-status"
                                                ...
                                                <div class="status-name">
                                                    ...
                                                    <div class="arrow"><svg width="14" height="7"
                                                            viewBox="0 0 22 11" fill="none"
                ...
                <div class="admin-pagination center"></div>
            </div>
        </div>
    </div>
@endsection
...
@section('modal')
    <div class="modal fade" id="quantri" tabindex="-1" aria-labelledby="exampleModalXlLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formquantri" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-add">
                                    ...
                                    <div class="col-9 d-flex flex-wrap">
                                        <div class="form-group col-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="input100 form-control" name="username"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-group col-4">
