                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-7" method="post" action="{{ route('user.doi-mat-khau-post')}}">
                                        @csrf
                                        <input type="id" name="id" value="{{$id}}" id="idphongdoimatkhau" hidden>
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <input name="password_confirmation" type="password" id="password_confirmationaaa"
